...
function copy_files() {
    ...
    rm "$QML_BASE/Opal/LinkHandler/private/ExtraTranslations.qml" || true
    rmdir --ignore-fail-on-non-empty "$QML_BASE/Opal/LinkHandler/private"
    ...
    printf "%s\n" \
        ...
        "}" "" > "$QML_BASE/Opal/LinkHandler/OpalLinkHandlerAttribution.qml"
    # REUSE-IgnoreEnd
}
